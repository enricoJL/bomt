...
Since then, and even before graduating, I have had many opportunities to work as a computer scientist, analyst, developer and consultant architect. Remarkably, I never had to actively search for a job. Each time, someone reached out to me through online networks or personal connections to offer a position. The only exception might be the last role I took as a manager.
